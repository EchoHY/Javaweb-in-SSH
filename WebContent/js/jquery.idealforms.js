...
$.idealforms.errors = {
  ...
  number: '此处必须输入数字',
  digits: '密码和确认密码不同',
  name: '最少三个字符,至少包含一个字母',
  username: '以字母开头,请使用4-32个字符可以包含字母,数字,下划线',
  pass: '6-25个字符,必须包含字母和数字,不得含有特殊字符',
  strongpass: '最少8个字符,必须包含,大写字母,小写字母和数字',
  email: '格式形如 <em>example@example.com</em>',
  phone: '请输入您正确的qq号',
...
var _defaults = {
  ...
  customFlags: {},
  globalFlags: '',
	onSuccess: function(e) { document.getElementById("test").innerHTML+="您的用户名被注册啦!";},
  responsiveAt: 'auto',
  disableCustom: ''
}
